 ...
 * without touching the other). iOS uses the real units; Android stays on
 * Google's test unit until the Android AdMob app and units exist. The card
 * always requests non-personalized ads per the app's policy (no ATT prompt).
 */
